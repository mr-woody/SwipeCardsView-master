...
import com.huxq17.swipecardsview.CardItemView;
...
public class MeiziAdapter extends BaseCardAdapter {
    ...
    public void onBindData(int position, View cardview) {
        ...
        CardItemView imageView = (CardItemView) cardview.findViewById(R.id.iv_meizi);
        ContentBean meizi = datas.get(position);
        String url = meizi.getUrl();
        Picasso.with(context).load(url).config(Bitmap.Config.RGB_565).into(imageView.imageView);
    }
